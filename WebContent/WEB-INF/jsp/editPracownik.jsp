...
#resume_content{
    ...
    <body>  
     ...
     <b>Edytowanie danych pracownika</b>  
      ...
      <div>  
       <form:form method="post" action="updatePracownik" modelAttribute="pracownik">  
        <table>  
         <tr>  
          <td>Imie :</td>  
         ...
         <tr>  
          <td>Nazwisko :</td>  
          <td><form:input path="nazwisko" value="${map.pracownik.nazwisko}" />  
          </td>  
         </tr>  
         <tr>  
          <td>Data zatrudnienia :</td>  
          <td><form:input path="data_zatrudnienia" value="${map.pracownik.data_zatrudnienia}" />  
          </td>  
         </tr>  
         <tr>
         <tr>  
          <td>Pensja:</td>  
          <td><form:input path="pensja" value="${map.pracownik.pensja}" />  
          </td>  
         </tr>  
         <tr>
         <tr>  
          <td>Telefon :</td>  
          <td><form:input path="telefon" value="${map.pracownik.telefon}" />  
          </td>  
         </tr>   
        ...
        <form:hidden path="id_pracownika" value="${map.pracownik.id_pracownika}" />  
