     ...
     <b>Wypożyczenia</b>  
      ...
      <table border="1">  
       <tr>  
        ...
        <td class="heading">Data wypozyczenia</td>  
        <td class="heading">Imie klienta</td>
        <td class="heading">Nazwisko klienta</td>
        <td class="heading">Marka samochodu</td>
       ...
       <c:forEach var="wypozyczenie" items="${wypozyczenieList}">  
        <tr>  
         ...
         <td>${wypozyczenie.nazwa_samochodu}</td>   
         <td>${wypozyczenie.miejsce_id_miejsca}</td>
         <td>${wypozyczenie.imie_pracownika}</td>
         <td>${wypozyczenie.nazwisko_pracownika}</td>  
         <td><a href="editWypozyczenie?id=${wypozyczenie.id_wypozyczenia}">Edytuj</a></td>  
